  ...
  import ActivityOptions from './options/+page.svelte';
      
  const routes = {
      '/app/activities/': ActivityOptions,
  };
    ...
    return [
      { name: 'Football', img: '/Sports/Full/Football-icon.png', favored: false, starImg: emptyStar },
      { name: 'Running', img: '/Sports/Full/Running-icon.png', favored: false, starImg: emptyStar  },
      { name: 'Hiking', img: '/Sports/Full/Hiking-icon.png', favored: false, starImg: emptyStar  },
      { name: 'Volleyball', img: '/Sports/Full/Volleyball-icon.png', favored: false, starImg: emptyStar  },
      { name: 'Basketball', img: '/Sports/Full/Basketball-icon.png', favored: false, starImg: emptyStar  },
      // ... other activities
    ];
  }
