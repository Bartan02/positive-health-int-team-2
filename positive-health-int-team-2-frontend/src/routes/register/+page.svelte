<div class="flex justify-between flex-col w-screen h-screen">
    ...
    <div class="w-full h-full center flex-col">          
        ...
        <div class="w-full h-2/3">
            ...
            <div class="center h-10">
                <div class="w-2/3 h-full center border-b border-orange-400">
                    <input type="text" placeholder="E-Mail" class="bg-transparent outline-none w-full">
                </div>  
            </div>    
            <div class="center h-10">
                <div class="w-2/3 h-full center border-b border-orange-400">
                    <input type="text" placeholder="Password" class="bg-transparent outline-none w-full">
                </div>  
            </div>  
            <div class="center h-10">
                <div class="w-2/3 h-full center border-b border-orange-400">
                    <input type="text" placeholder="Confirm Password" class="bg-transparent outline-none w-full">
                </div>
            </div>
